...
[Youtube Demo Video](https://youtu.be/Zoz8oPeqHWI "Youtube Video Demo")
...
4. `node liri.js do-what-it-says`
   ...
   * Using the `fs` Node package, LIRI will take the text inside of random.txt and then use it to call one of LIRI's commands.
     ...
     * It runs a random command, to read a randomly selected previous search term and send the query
